...
SECRET_KEY = 'k72yqww%5imde)ah2!-i=)@xkgg8bfa%0gae6$fk3#u28rwah='
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'airline/templates'),

            os.path.join(BASE_DIR, 'reservation/templates'),

            os.path.join(BASE_DIR, 'login/templates'),
            os.path.join(BASE_DIR, 'join/templates'),

            os.path.join(BASE_DIR, 'admin_manage/templates'),

            os.path.join(BASE_DIR, 'board/templates'),

            os.path.join(BASE_DIR, 'inquiry/templates'),
            os.path.join(BASE_DIR, 'seats/templates'),
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'admin_manage/static'),

    os.path.join(BASE_DIR, 'inquiry/static'),
    os.path.join(BASE_DIR, 'seats/static'),
